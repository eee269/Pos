...
<!-- 		  <a href="javascript:print_opt();" class="btn btn-success btn-sm">Print</a> -->
		  ...
		  <a href="items_price.php" class="btn btn-success btn-sm">Price List</a>
		  <a href="<c:url value='/ctg/list' />" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add New</a></div>
		<script>
		function print_opt()
		{
